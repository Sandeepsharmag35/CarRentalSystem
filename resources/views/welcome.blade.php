@extends('header')
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="section-img-with-tab" data-bgcolor="#f8f8f8">
                ...
                <div class="image-container col-md-6 pull-right" style="background-image: url('{{ asset('images/cars/ford-raptor.jpg') }}'); background-position: center center; background-size: cover;"></div>
            ...
            <section id="section-fun-facts" class="bg-color text-light mt100">
                <div class="container">
