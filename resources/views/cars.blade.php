                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        ...
                                        <div class="d-atr-group">
                                                    <span class="d-atr"><img src="{{asset('images/icons/1.svg')}}" alt="">5</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/2.svg')}}" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/3.svg')}}" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/4.svg')}}" alt="">SUV</span>
                                                </div>
                                                <div class="d-price">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        ...
                                        <div class="d-atr-group">
                                                    ...
                                                    <span class="d-atr"><img src="{{asset('images/icons/2.svg')}}" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/3.svg')}}" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/4.svg')}}" alt="">Sedan</span>
                                                </div>
                                                <div class="d-price">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        ...
                                        <div class="d-atr-group">
                                                    ...
                                                    <span class="d-atr"><img src="{{asset('images/icons/2.svg')}}" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/3.svg')}}" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/4.svg')}}" alt="">Exotic Car</span>
                                                </div>
                                                <div class="d-price">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        ...
                                        <div class="d-atr-group">
                                                    ...
                                                    <span class="d-atr"><img src="{{asset('images/icons/2.svg')}}" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/3.svg')}}" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/4.svg')}}" alt="">Pickup Truck</span>
                                                </div>
                                                <div class="d-price">
                                ...
                                <div class="col-xl-4 col-lg-6">
                                    <div class="de-item mb30">
                                        ...
                                        <div class="d-atr-group">
                                                    ...
                                                    <span class="d-atr"><img src="{{asset('images/icons/2.svg')}}" alt="">2</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/3.svg')}}" alt="">4</span>
                                                    <span class="d-atr"><img src="{{asset('images/icons/4.svg')}}" alt="">Hatchback</span>
                                                </div>
                                                <div class="d-price">
